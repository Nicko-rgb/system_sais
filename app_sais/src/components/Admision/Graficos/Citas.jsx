...
const Citas = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                let url = `${API_URL}/api/stadist/citas-por-tiempo/?periodo=${periodo}`;
                if (periodo === 'mes') {
                ...
                if (response.data.message) {
                    const mensajePersonalizado = periodo === 'mes' 
                        ? 'No hay registros de citas disponibles.' 
                        : 'No hay registros de citas disponibles para este año';
    ...
    return (
        <div className="box-grafico">
            <h2 className='title-grafico'>Número de Citas Registradas</h2>
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <Tooltip
                            ...
                            formatter={(value) => [`Total: ${value}`, 'Citas']}
